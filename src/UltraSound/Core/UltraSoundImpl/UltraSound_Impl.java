...
public class UltraSound_Impl implements UltraSound_Out, UltraSound_IN {
	...
	// a te f�ggv�nyed random adatokkal if (inSectorOfTheCircle(new Point(100,
	...
	public boolean inSectorOfTheCircle(Point sensorMidPoint, int sensorViewDegree, Point obstacklePoint,
		...
		double sensorHalfViewDegree = Math.PI / 180 * sensorViewDegree / 2;// radi�nba
																			// �tv�lt�s
		...
		// sensor l�t�mez�j�nek k�zep�n tal�lhat� referencia pont meghat�roz�sa
		...
		// l�t�mez� k�zep�n elhelyezett refPonthoz
	...
	public Point viewDegreeCalibration(Point sensorMidPoint, int angleOnCar, int sensorNumberID) {
		...
		int offsetXpoint = sensorMidPoint.x - 50; // null�t deffelj�k majd
